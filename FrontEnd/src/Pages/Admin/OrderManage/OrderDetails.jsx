...
//       const res = await axios.get(`http://localhost:8081/api/admin/orders/${id}`);
...
//     try {
//       setSaving(true);
//       await axios.put(`http://localhost:8081/api/admin/orders/${id}/status`, {
...
//     try {
//       setSaving(true);
//       await axios.put(`http://localhost:8081/api/admin/orders/${id}/cancel`);
...
//                             <td style={{ padding: "14px", fontSize: 14, fontWeight: 600, color: "#111827" }}>{item.item_name || `Item #${item.item_id}`}</td>
//                             <td style={{ padding: "14px", fontSize: 13, color: "#374151" }}>{item.quantity}</td>
//                             <td style={{ padding: "14px", fontSize: 13, color: "#374151" }}>LKR {item.unit_price}</td>
//                             <td style={{ padding: "14px", fontSize: 13, fontWeight: 700, color: "#059669" }}>LKR {item.subtotal}</td>
//                           </tr>
//                         ))}
//                       </tbody>
//                     </table>
...
//                       <div style={{ fontSize: 22, fontWeight: 800, color: "#059669" }}>LKR {order.total_amount}</div>
//                     </div>
//                   </div>
//                 </div>
