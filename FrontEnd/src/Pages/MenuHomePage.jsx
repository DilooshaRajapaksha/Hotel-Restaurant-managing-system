    ...
    <>
      <style>{`
        ...
        .gs-icon {
          ...
          color: #a0781d; font-size: 24px;
          margin-bottom: 16px;
          box-shadow: inset 0 0 0 1px rgba(201,168,76,0.18);
        }

        .gs-card-title { font-size: 22px; font-weight: 800; color: #1f1a14; margin-bottom: 10px; }
        .gs-card-text  { color: #5e5548; line-height: 1.8; font-size: 15px; }

        .gs-banner { max-width: 1200px; margin: 0 auto; padding: 0 24px 24px; }

        .gs-banner-inner {
          position: relative; overflow: hidden;
          border-radius: 30px; padding: 40px 36px;
          background: linear-gradient(135deg, rgba(47,38,29,0.96), rgba(96,74,31,0.92));
          color: #fff7e1;
        ...
        .gs-banner-text { max-width: 660px; color: #f4e7c8; line-height: 1.8; margin: 0; }
        ...
        .gs-banner-btn:hover { transform: translateY(-2px); }

        /* ── Responsive ── */
        @media (max-width: 900px) {
          .gs-grid-3 { grid-template-columns: 1fr; gap: 16px; }
          .gs-section { padding: 48px 18px; }
        }

        @media (max-width: 600px) {
          .gs-section-text { font-size: 15px; }
          .gs-banner-inner { padding: 28px 20px; border-radius: 20px; }
          .gs-banner-content { flex-direction: column; align-items: flex-start; }
          .gs-banner-btn { width: 100%; text-align: center; }
        }
      `}</style>
