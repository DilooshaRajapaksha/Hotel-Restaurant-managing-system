      ...
      <div style={{ padding: "12px 20px", borderTop: "1px solid #F3F4F6", background: "#FAFAFA", display: "flex", alignItems: "center", gap: 10, flexWrap: "wrap" }}>
        ...
        {nextSc && (
          <button onClick={handleNextStatus} disabled={updating}
            ...
            {updating ? "Updating..." : `Mark as ${nextSc.label} →`}
          </button>
        )}
        ...
        <div style={{ flex: 1, display: "flex", flexDirection: "column", minWidth: 0, overflow: "auto" }}>
          ...
          <div style={{ padding: "28px 32px", flex: 1 }}>
            ...
            <div style={{ background: "#fff", borderRadius: 16, boxShadow: "0 1px 3px rgba(0,0,0,0.06),0 4px 16px rgba(0,0,0,0.04)", overflow: "hidden", marginBottom: 24 }}>
              ...
              <div style={{ height: 80, background: `linear-gradient(135deg,${NAVY},#2D4270)` }} />

              <div style={{ padding: "0 28px 24px" }}>

                <div style={{ display: "flex", alignItems: "flex-end", gap: 20, marginTop: -36, marginBottom: 20 }}>
                  <div style={{ width: 72, height: 72, borderRadius: "50%", background: `linear-gradient(135deg,${GOLD},#8B6914)`, display: "flex", alignItems: "center", justifyContent: "center", fontSize: 28, fontWeight: 800, color: "#fff", border: "4px solid #fff", boxShadow: "0 4px 12px rgba(0,0,0,0.15)", flexShrink: 0 }}>
                    {(staff.sName || "?").charAt(0).toUpperCase()}
                  </div>
                  <div style={{ paddingBottom: 4 }}>
                    <h2 style={{ fontSize: 22, fontWeight: 800, color: "#111827", marginBottom: 2 }}>{staff.sName}</h2>
                    <span style={{ fontSize: 12, background: "#FFFBEB", color: "#92400E", fontWeight: 600, padding: "2px 10px", borderRadius: 20, border: `1px solid ${GOLD}44` }}>
